...
const mockCharacterTypeMelee = {
  name: "Melee",
  distanceRange: 2,
};

const mockCharacterTypeRanged = {
  name: "Ranged",
  distanceRange: 20,
};
...
describe("Character", () => {
  ...
  it("Should damage is reduced by 50%", () => {
    ...
    expect(character2.health).toBe(
      earlyHealth - (character1.damage - (character1.damage * 50) / 100)
    );
  });
  ...
  it("Should damage is increased by 50%", () => {
    ...
    expect(character1.health).toBe(
      earlyHealth - (character2.damage + (character2.damage * 50) / 100)
    );
  });
